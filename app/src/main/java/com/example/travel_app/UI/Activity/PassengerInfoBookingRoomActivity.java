...
public class PassengerInfoBookingRoomActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_passenger_info_booking_room);

//        passenger = (Passenger) getIntent().getSerializableExtra("passenger_KEY");
//        customerIndex = getIntent().getIntExtra("passengerIndex_KEY", -1);
        ...
        btnSave.setOnClickListener(v -> {
            if (validatePassengerInfo()) {
                Intent resultIntent = new Intent(this, HotelPaymentActivity.class);
                resultIntent.putExtra("updatedPassenger_KEY", passenger);
                resultIntent.putExtra("passengerIndex_KEY", customerIndex);
